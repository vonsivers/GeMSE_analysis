...
// ---------------------------------------------------------
BCMTF_HPGe::BCMTF_HPGe(const char * name)
   : BCModel(name)
   , fNChannels(0)
   , fNProcesses(0)
   , fNSystematics(0)
...
// ---------------------------------------------------------
int BCMTF_HPGe::GetChannelIndex(const char * name)
{
...
// ---------------------------------------------------------
int BCMTF_HPGe::GetProcessIndex(const char * name)
{
...
// ---------------------------------------------------------
int BCMTF_HPGe::GetSystematicIndex(const char * name)
{
...
// ---------------------------------------------------------
int BCMTF_HPGe::SetTemplate(const char * channelname, const char * processname, TH1D hist, double efficiency, double norm)
{
   // get channel index
...
// ---------------------------------------------------------
int BCMTF_HPGe::SetTemplate(const char * channelname, const char * processname, std::vector<TF1 *> * funccont, int nbins, double efficiency)
{
   // get channel index
   int channelindex = GetChannelIndex(channelname);
...
// ---------------------------------------------------------
int BCMTF_HPGe::SetData(const char * channelname, TH1D hist, double minimum, double maximum)
{
   int channelindex = GetChannelIndex(channelname);
...
// ---------------------------------------------------------
int BCMTF_HPGe::AddChannel(const char * name)
{
   // check if channel exists
   for (int i = 0; i < fNChannels; ++i) {
      // compare names
...
// ---------------------------------------------------------
int BCMTF_HPGe::AddProcess(const char * name, double nmin, double nmax, int color, int fillstyle, int linestyle)
{
   // check if process exists
   for (int i = 0; i < fNProcesses; ++i) {
      // compare names
...
// ---------------------------------------------------------
int BCMTF_HPGe::AddSystematic(const char * name, double min, double max)
{
...
// ---------------------------------------------------------
int BCMTF_HPGe::SetSystematicVariation(const char * channelname, const char * processname,  const char * systematicname, double variation_up, double variation_down)
{
...
// ---------------------------------------------------------
int BCMTF_HPGe::SetSystematicVariation(const char * channelname, const char * processname,  const char * systematicname, TH1D hist_up, TH1D hist_down)
{
   // get channel index
   int channelindex = GetChannelIndex(channelname);
...
// ---------------------------------------------------------
int BCMTF_HPGe::SetSystematicVariation(const char * channelname, const char * processname,  const char * systematicname, TH1D hist, TH1D hist_up, TH1D hist_down)
{
   // get number of bins
...
// ---------------------------------------------------------
int BCMTF_HPGe::PrintSummary(const char * filename)
{
   // open file
...
// ---------------------------------------------------------
double BCMTF_HPGe::Expectation(int channelindex, int binindex, const std::vector<double> & parameters)
{
...
// ---------------------------------------------------------
double BCMTF_HPGe::ExpectationFunction(int parindex, int channelindex, int processindex, const std::vector<double> & parameters)
{
...
// ---------------------------------------------------------
double BCMTF_HPGe::Efficiency(int channelindex, int processindex, int binindex, const std::vector<double> & parameters)
{
   // get channel
...
// ---------------------------------------------------------
double BCMTF_HPGe::Probability(int channelindex, int processindex, int binindex, const std::vector<double> & parameters)
{
   // get histogram
...
// ---------------------------------------------------------
int BCMTF_HPGe::PrintStack(const char * channelname, const std::vector<double> & parameters, const char * filename, const char * options)
{
...
// ---------------------------------------------------------
int BCMTF_HPGe::PrintStack(int channelindex, const std::vector<double> & parameters, const char * filename, const char * options)
{
   // todo:
   ...
   if (!(GetMarginalizationMethod() == BCIntegrate::kMargMetropolis)) {
     flag_b0 = false;
     flag_b1 = false;
     BCLog::OutWarning("BCMTF_HPGe::PrintStack : Did not run MCMC. Error bands are not available.");
   }
...
// ---------------------------------------------------------
double BCMTF_HPGe::CalculateChi2(int channelindex, const std::vector<double> & parameters)
{
...
// ---------------------------------------------------------
double BCMTF_HPGe::CalculateChi2(const std::vector<double> & parameters)
{
   if (parameters.size() == 0)
      return -1;
...
// ---------------------------------------------------------
double BCMTF_HPGe::CalculateCash(int channelindex, const std::vector<double> & parameters)
{
   if (parameters.size() == 0)
      return -1;
...
// ---------------------------------------------------------
double BCMTF_HPGe::CalculateCash(const std::vector<double> & parameters)
{
   if (parameters.size() == 0)
      return -1;
...
// ---------------------------------------------------------
double BCMTF_HPGe::CalculatePValue(int channelindex, const std::vector<double> & parameters)
{
   // get channel
   BCMTFChannel * channel = GetChannel(channelindex);
...
// ---------------------------------------------------------
double BCMTF_HPGe::CalculatePValue(const std::vector<double> & parameters)
{
...
// ---------------------------------------------------------
double BCMTF_HPGe::LogLikelihood(const std::vector<double> & parameters)
{
   double logprob = 0.;
   ...
   for (int ichannel = 0; ichannel < fNChannels; ++ichannel) {
      ...
      BCMTFChannel * channel = fChannelContainer[ichannel];
       ...
       double t_meas;
       // first channel is sample spectrum, second is bck spectrum
       if (ichannel % 2 == 0) {
           t_meas = ft_sample;
       }
       else {
      ...
      for (int ibin = 1; ibin <= nbins; ++ibin) {
         ...
         // add Poisson term
         logprob += BCMath::LogPoisson(observation*t_meas, expectation*t_meas)+fconstant;
      }
   }
...
// ---------------------------------------------------------
void BCMTF_HPGe::MCMCUserIterationInterface()
{
   // loop over all channels
   for (int ichannel = 0; ichannel < fNChannels; ++ichannel) {
...
// ---------------------------------------------------------
void BCMTF_HPGe::SetConstant(double constant)
{
    fconstant = constant;
}

// ---------------------------------------------------------
void BCMTF_HPGe::SetMeasurementTimes(double t_sample, double t_bck)
{
    ft_sample = t_sample;
    ft_bck = t_bck;
}
