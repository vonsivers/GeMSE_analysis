...
// ---------------------------------------------------------
class BCMTF_HPGe : public BCModel
{
...
public:
        ...
        /**
         * Method to set the constant that is added to the loglikelihood
         * to get a non-zero result after integration*/
        void SetConstant(double constant);
    
    /**
     * Method to set the measurement times of the sample and background spectra
     * This should only be used when the data histograms are scaled with the measurement time
     i.e. the y-axis shows the count rate instead of counts */
...
private:
        ...
        /**
        * A constant added when calculating the loglikelihood 
        * necessary to get a non-zero result in the integration
        * when calculating the Bayes Factor */
        double fconstant;
